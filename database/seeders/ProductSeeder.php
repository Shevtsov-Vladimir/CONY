...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            ['vendor_code' => 45796128, 'title' => 'Браслет', 'description' => 'Наш браслет изготовлен из эстетичного и модного бижутерного сплава, который придает ему изысканность и стиль. Без вставок и гладкий внешний вид делают его минималистичным и подходящим для любого наряда. Жесткий и широкий дизайн из бижутерии стали придает этому аксессуару долговечность и привлекательность. Этот браслет станет прекрасным подарком для вашей любимой, добавив ее образу неповторимый шарм и стиль.', 'price' => 550, 'quantity' => 10, 'photo' => '/img/Браслет8.jpg', 'category_id' => 3, 'created_at' => Now(), 'updated_at' => Now()],
        ]);
    }
}
